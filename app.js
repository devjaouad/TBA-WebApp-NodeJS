...
var violationController = require('./controllers/violation');
...
app.use(function(req, res, next) {
  ...
  res.locals.owner = req.owners;
  res.locals.taxi = req.taxi;
  res.locals.violation = req.violation;
...
app.get('/violation', violationController.getAddViolation);
app.post('/violation', violationController.postAddViolation);
app.get('/UpdateViolation', violationController.getUpdateViolation);
app.post('/UpdateViolation', violationController.postUpdateViolation);
app.get('/AllViolations', violationController.getAllViolations);
app.post('/searchViolation', violationController.postSearchViolation);
app.post('/deleteViolation', violationController.postDeleteViolation);
app.post('/goToEditViolation', violationController.postGoToEditViolation);
app.get('/owner', ownerController.getAddOwner);
app.post('/owner', ownerController.postAddOwner);
app.post('/searchOwner', ownerController.postSearchOwner);
app.get('/UpdateOwner', ownerController.getUpdateOwner);
app.post('/UpdateOwner', ownerController.postUpdateOwner);
app.get('/AllOwners', ownerController.getAllOwners);
app.post('/deleteOwner', ownerController.postDeleteOwner);
app.post('/goToEditOwner', ownerController.postGoToEditOwner);
app.get('/taxi', taxiController.getAddTaxi);
app.post('/taxi', taxiController.postAddTaxi);
app.get('/UpdateTaxi', taxiController.getUpdateTaxi);
app.post('/UpdateTaxi', taxiController.postUpdateTaxi);
app.get('/TaxiIncome', taxiController.getAllTaxiIncome);
app.get('/WeeklyIncome', taxiController.getTaxiWeeklyIncome);
app.post('/searchTaxiIncome', taxiController.postSearchTaxi);
app.post('/searchWeeklyIncome', taxiController.postSearchWeeklyIncome);
app.post('/searchYearlyIncome', taxiController.postSearchYearlyIncome);
app.get('/grandTotal', taxiController.getTaxiGrandTotal);
app.post('/deleteIncome', taxiController.postDeleteTaxi);
app.get('/WeeklyIncome', taxiController.getWeeklyIncome);
app.post('/goToEditIncome', taxiController.postGoToEditTaxi);
app.get('/GrandTotal', taxiController.getTaxiGrandTotal);
...
app.use(function errorHandler(err, req, res, next) {
  ...
  res.status(500);
  req.flash('errors', {
    msg: 'There was an error! Please contact the' +
      ' administrator'
  });
...
//If a user request a page that doesn't exist, this page
//will be displayed 404.ejs
